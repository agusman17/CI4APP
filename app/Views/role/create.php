    ...
    <div class="px-4 py-3 my-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form action="<?= base_url('role'); ?>" method="post">
            ...
            <label class="block text-sm mb-6">
                ...
                <input name="name" value="<?= old('name'); ?>" class="block w-full mt-1 text-sm border-<?= $errColorName; ?>-200 dark:border-gray-600 dark:bg-gray-700 focus:border-<?= $errColorName; ?>-400 focus:outline-none focus:shadow-outline-<?= $errColorName; ?> dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Example : Admin Keuangan">
