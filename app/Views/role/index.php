...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex items-center justify-between h-full">
        ...
        <a href="<?= base_url('role/create'); ?>" class="flex items-center justify-between px-4 py-2 mt-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 w-1/4 text-md text-center">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="<?= base_url('role/edit/' . $role['id']); ?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
