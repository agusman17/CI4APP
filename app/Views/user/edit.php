    ...
    <div class="px-4 py-3 my-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form action="<?= base_url('user/' . $user['id']); ?>" method="post">
            ...
            <label class="block mt-4 text-sm mb-6">
                ...
                <textarea name="address" class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" rows="3" placeholder="Example : Jl. Sejahtera No.1"><?= $user['address']; ?></textarea>
            </label>

            <button type="submit" class="flex items-center justify-center px-4 py-2 mb-6 text-sm border-gray-300 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
