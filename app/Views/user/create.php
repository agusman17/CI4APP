...
<div class="container px-6 mx-auto grid">
    ...
    <div class="px-4 py-3 my-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form action="<?= base_url('user'); ?>" method="post">
            ...
            <button type="submit" class="float-right flex items-center justify-center px-4 py-2 mb-6 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
